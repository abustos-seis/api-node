...
describe("Inspect module", function () {
  ...
  it("should get all tags", function () {
    ...
    expect(iModule.inspect.templatedFiles).to.be.deep.equal(["ppt/slides/slide1.xml", "ppt/slides/slide2.xml", "ppt/slideMasters/slideMaster1.xml", "ppt/presentation.xml", "docProps/app.xml", "docProps/core.xml"]);
  });
